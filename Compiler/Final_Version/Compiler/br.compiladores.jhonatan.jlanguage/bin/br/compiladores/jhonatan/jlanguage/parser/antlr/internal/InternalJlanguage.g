...
@after {
	...
	(
		...
		{
			$current = $this_ComandoAtibuicao_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_ComandoSubAlgoritmo_5.current;
			afterParserOrEnumRuleCall();
		}
	)
;

// Entry rule entryRuleComandoAtibuicao
entryRuleComandoAtibuicao returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getComandoAtibuicaoRule()); }
	iv_ruleComandoAtibuicao=ruleComandoAtibuicao
	{ $current=$iv_ruleComandoAtibuicao.current; }
	EOF;

// Rule ComandoAtibuicao
ruleComandoAtibuicao returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
// Entry rule entryRuleComandoSubAlgoritmo
entryRuleComandoSubAlgoritmo returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getComandoSubAlgoritmoRule()); }
	iv_ruleComandoSubAlgoritmo=ruleComandoSubAlgoritmo
	{ $current=$iv_ruleComandoSubAlgoritmo.current; }
	EOF;

// Rule ComandoSubAlgoritmo
ruleComandoSubAlgoritmo returns [EObject current=null]
@init {
	enterRule();
}
@after {
