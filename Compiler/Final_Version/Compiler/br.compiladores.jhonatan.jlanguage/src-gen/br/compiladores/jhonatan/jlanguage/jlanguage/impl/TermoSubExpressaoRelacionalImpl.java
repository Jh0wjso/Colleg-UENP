 ...
 * </p>
 * <ul>
 *   <li>{@link br.compiladores.jhonatan.jlanguage.jlanguage.impl.TermoSubExpressaoRelacionalImpl#getExpRel <em>Exp Rel</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TermoSubExpressaoRelacionalImpl extends TermoRelacionalImpl implements TermoSubExpressaoRelacional
{
  ...
  {
    return JlanguagePackage.Literals.TERMO_SUB_EXPRESSAO_RELACIONAL;
  }
  ...
  public NotificationChain basicSetExpRel(ExpressaoRelacional newExpRel, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JlanguagePackage.TERMO_SUB_EXPRESSAO_RELACIONAL__EXP_REL, oldExpRel, newExpRel);
  ...
  public void setExpRel(ExpressaoRelacional newExpRel)
  {
    if (newExpRel != expRel)
    {
      ...
      if (expRel != null)
        msgs = ((InternalEObject)expRel).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JlanguagePackage.TERMO_SUB_EXPRESSAO_RELACIONAL__EXP_REL, null, msgs);
      if (newExpRel != null)
        msgs = ((InternalEObject)newExpRel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JlanguagePackage.TERMO_SUB_EXPRESSAO_RELACIONAL__EXP_REL, null, msgs);
      msgs = basicSetExpRel(newExpRel, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, JlanguagePackage.TERMO_SUB_EXPRESSAO_RELACIONAL__EXP_REL, newExpRel, newExpRel));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case JlanguagePackage.TERMO_SUB_EXPRESSAO_RELACIONAL__EXP_REL:
