 ...
 * @generated
 */
public class JlanguagePackageImpl extends EPackageImpl implements JlanguagePackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  private EClass comandoAtibuicaoEClass = null;
   ...
   * @see br.compiladores.jhonatan.jlanguage.jlanguage.JlanguagePackage#eNS_URI
   * @see #init()
   * @generated
   */
  private JlanguagePackageImpl()
  {
    super(eNS_URI, JlanguageFactory.eINSTANCE);
  }
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   *
   * <p>This method is used to initialize {@link JlanguagePackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static JlanguagePackage init()
  {
    if (isInited) return (JlanguagePackage)EPackage.Registry.INSTANCE.getEPackage(JlanguagePackage.eNS_URI);

    // Obtain or create and register package
    Object registeredJlanguagePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    JlanguagePackageImpl theJlanguagePackage = registeredJlanguagePackage instanceof JlanguagePackageImpl ? (JlanguagePackageImpl)registeredJlanguagePackage : new JlanguagePackageImpl();

    isInited = true;

    // Create package meta-data objects
    theJlanguagePackage.createPackageContents();

    // Initialize created meta-data
    theJlanguagePackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theJlanguagePackage.freeze();

    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(JlanguagePackage.eNS_URI, theJlanguagePackage);
    return theJlanguagePackage;
  }
   ...
   */
  @Override
  public EReference getTermoComparacaoRelacional_Expr1()
  {
   ...
   */
  @Override
  public EReference getTermoComparacaoRelacional_Expr2()
  {
   ...
   */
  @Override
  public EClass getComandoAtibuicao()
  {
    return comandoAtibuicaoEClass;
  }
   ...
   */
  @Override
  public EReference getComandoAtibuicao_Exp()
  {
    return (EReference)comandoAtibuicaoEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getComandoAtibuicao_Variavel()
  {
    return (EReference)comandoAtibuicaoEClass.getEStructuralFeatures().get(1);
  }
   ...
   */
  @Override
  public EClass getComandoSubAlgoritmo()
  {
    return comandoSubAlgoritmoEClass;
  }
   ...
   */
  @Override
  public EReference getComandoSubAlgoritmo_Comandos()
  {
    return (EReference)comandoSubAlgoritmoEClass.getEStructuralFeatures().get(0);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(termoComparacaoRelacionalEClass, TERMO_COMPARACAO_RELACIONAL__EXPR1);
    createEAttribute(termoComparacaoRelacionalEClass, TERMO_COMPARACAO_RELACIONAL__OP_REL);
    createEReference(termoComparacaoRelacionalEClass, TERMO_COMPARACAO_RELACIONAL__EXPR2);
    ...
    comandoAtibuicaoEClass = createEClass(COMANDO_ATIBUICAO);
    createEReference(comandoAtibuicaoEClass, COMANDO_ATIBUICAO__EXP);
    createEReference(comandoAtibuicaoEClass, COMANDO_ATIBUICAO__VARIAVEL);
  ...
  public void initializePackageContents()
  {
    ...
    comandoAtibuicaoEClass.getESuperTypes().add(this.getComando());
    ...
    comandoSubAlgoritmoEClass.getESuperTypes().add(this.getComando());
    ...
    initEReference(getTermoComparacaoRelacional_Expr1(), this.getExpressaoAritmetica(), null, "expr1", null, 0, 1, TermoComparacaoRelacional.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getTermoComparacaoRelacional_Expr2(), this.getExpressaoAritmetica(), null, "expr2", null, 0, 1, TermoComparacaoRelacional.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(comandoAtibuicaoEClass, ComandoAtibuicao.class, "ComandoAtibuicao", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getComandoAtibuicao_Exp(), this.getExpressaoAritmetica(), null, "exp", null, 0, 1, ComandoAtibuicao.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getComandoAtibuicao_Variavel(), this.getDeclaracao(), null, "variavel", null, 0, 1, ComandoAtibuicao.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
