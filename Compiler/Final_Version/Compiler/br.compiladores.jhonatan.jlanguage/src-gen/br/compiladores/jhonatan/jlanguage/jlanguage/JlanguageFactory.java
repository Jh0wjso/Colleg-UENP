 ...
 * @generated
 */
public interface JlanguageFactory extends EFactory
{
  /**
   ...
   * @generated
   */
  JlanguageFactory eINSTANCE = br.compiladores.jhonatan.jlanguage.jlanguage.impl.JlanguageFactoryImpl.init();
  ...
  /**
   * Returns a new object of class '<em>Comando Atibuicao</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Comando Atibuicao</em>'.
   * @generated
   */
  ComandoAtibuicao createComandoAtibuicao();
  ...
  /**
   * Returns a new object of class '<em>Comando Sub Algoritmo</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Comando Sub Algoritmo</em>'.
   * @generated
   */
   ...
   * @generated
   */
  JlanguagePackage getJlanguagePackage();
