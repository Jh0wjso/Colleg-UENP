 ...
 * </p>
 * <ul>
 *   <li>{@link br.compiladores.jhonatan.jlanguage.jlanguage.impl.OutroTermoRelacionalImpl#getOperador <em>Operador</em>}</li>
 *   <li>{@link br.compiladores.jhonatan.jlanguage.jlanguage.impl.OutroTermoRelacionalImpl#getTermo <em>Termo</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OutroTermoRelacionalImpl extends MinimalEObjectImpl.Container implements OutroTermoRelacional
{
  ...
  {
    return JlanguagePackage.Literals.OUTRO_TERMO_RELACIONAL;
  }
  ...
  public void setOperador(String newOperador)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, JlanguagePackage.OUTRO_TERMO_RELACIONAL__OPERADOR, oldOperador, operador));
  }
  ...
  public NotificationChain basicSetTermo(TermoRelacional newTermo, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JlanguagePackage.OUTRO_TERMO_RELACIONAL__TERMO, oldTermo, newTermo);
  ...
  public void setTermo(TermoRelacional newTermo)
  {
    if (newTermo != termo)
    {
      ...
      if (termo != null)
        msgs = ((InternalEObject)termo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JlanguagePackage.OUTRO_TERMO_RELACIONAL__TERMO, null, msgs);
      if (newTermo != null)
        msgs = ((InternalEObject)newTermo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JlanguagePackage.OUTRO_TERMO_RELACIONAL__TERMO, null, msgs);
      msgs = basicSetTermo(newTermo, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, JlanguagePackage.OUTRO_TERMO_RELACIONAL__TERMO, newTermo, newTermo));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case JlanguagePackage.OUTRO_TERMO_RELACIONAL__TERMO:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case JlanguagePackage.OUTRO_TERMO_RELACIONAL__OPERADOR:
        return getOperador();
      case JlanguagePackage.OUTRO_TERMO_RELACIONAL__TERMO:
        return getTermo();
    }
