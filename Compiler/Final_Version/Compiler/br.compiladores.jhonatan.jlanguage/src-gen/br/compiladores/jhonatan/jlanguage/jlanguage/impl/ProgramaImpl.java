 ...
 * </p>
 * <ul>
 *   <li>{@link br.compiladores.jhonatan.jlanguage.jlanguage.impl.ProgramaImpl#getDeclaracoes <em>Declaracoes</em>}</li>
 *   <li>{@link br.compiladores.jhonatan.jlanguage.jlanguage.impl.ProgramaImpl#getComandos <em>Comandos</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProgramaImpl extends MinimalEObjectImpl.Container implements Programa
{
  ...
  {
    return JlanguagePackage.Literals.PROGRAMA;
  }
  ...
  public EList<Declaracao> getDeclaracoes()
  {
    if (declaracoes == null)
    {
      declaracoes = new EObjectContainmentEList<Declaracao>(Declaracao.class, this, JlanguagePackage.PROGRAMA__DECLARACOES);
    }
    return declaracoes;
  }
  ...
  public EList<Comando> getComandos()
  {
    if (comandos == null)
    {
      comandos = new EObjectContainmentEList<Comando>(Comando.class, this, JlanguagePackage.PROGRAMA__COMANDOS);
    }
    return comandos;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case JlanguagePackage.PROGRAMA__DECLARACOES:
        return ((InternalEList<?>)getDeclaracoes()).basicRemove(otherEnd, msgs);
      case JlanguagePackage.PROGRAMA__COMANDOS:
